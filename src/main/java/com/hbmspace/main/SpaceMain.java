 ...
 * @author Th3_Sl1ze
 */
@Mod(modid = Tags.MODID, version = Tags.VERSION, name = Tags.MODNAME, acceptedMinecraftVersions = "[1.12.2]", dependencies = "required-after:hbm@[2.6.0.0,);required-after:mixinbooter@[10.6,)")
